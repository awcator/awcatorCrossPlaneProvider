# ====================================================================================
# Setup Project
PROJECT_NAME := provider-awcatorprovider
...
IMAGES = provider-awcatorprovider
...
XPKGS = provider-awcatorprovider
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-awcatorprovider: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider AwcatorProvider CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider AwcatorProvider controllers
...
# This target prepares repo for your provider by replacing all "awcatorprovider"
